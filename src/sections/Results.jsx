...
export default function Results({
  ...
  return (
    <div className="min-h-screen w-full flex justify-center bg-black py-6">
      {/* main results card – desktop ~65% width, mobile full */}
     <section className="w-full max-w-3xl lg:max-w-4xl lg:w-[65%] bg-black/80 backdrop-blur-2xl rounded-3xl border border-yellow-400/30 shadow-[0_0_40px_rgba(250,204,21,0.15)] px-3 sm:px-4 py-4 sm:py-5">
        {/* top bar */}
        <div className="flex items-start justify-between gap-3 flex-wrap">
          ...
          <button
            onClick={onBack}
            className="text-xs px-3 py-2 rounded-full border border-yellow-400/40 bg-black text-yellow-400 hover:bg-yellow-400/10 shadow-[0_0_20px_rgba(250,204,21,0.2)] hover:bg-slate-50 active:scale-[0.98] transition"
          >
            ← Change Search
          </button>
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          {/* Estimated distance */}
          <div className="p-3 rounded-xl border border-yellow-400/30 bg-black/60">
            ...
            <input
              ...
              className="mt-1 w-full p-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:border-yellow-400"
          ...
          {/* Arrival delay */}
         <div className="p-3 rounded-xl border border-yellow-400/30 bg-black/60 shadow-[0_0_15px_rgba(250,204,21,0.15)]">
            <label className="text-[11px] font-medium text-gray-600">
          ...
          <div className="p-3 rounded-xl border border-slate-200 bg-black/60 border border-yellow-400/30 col-span-2">
            <label className="text-[11px] font-medium text-yellow-300/80">
              Notes
            </label>
            <div className="text-[11px] mt-2 text-yellow-300/80 leading-snug">
              {subNote}
            </div>
          </div>
        </div>
        ...
        <div className="mt-5 space-y-3">
          {CARS.map((car) => {
            ...
            return (
              <div
                key={car.id}
               className="border border-yellow-400/30 rounded-2xl overflow-hidden bg-black/70 hover:border-yellow-400 transition-all duration-200"
              >
                <div className="p-3 flex items-center gap-3">
                  <div className="flex-shrink-0">
                    <img
                      src={car.img}
                      alt={car.title}
                      className="w-24 h-18 object-cover rounded-xl border border-yellow-400/30 bg-black"
                      onError={(e) => handleImageError(e, car.id)}
                    />
                  </div>

                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-[14px] text-yellow-400 truncate">
                      {car.title}
                    </h3>
                    ...
                    <button
                      ...
                      className="mt-1.5 text-[11px] font-medium text-yellow-400 hover:text-yellow-300"
                    >
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <button
                      ...
                      className="mt-1.5 px-3 py-2 rounded-full text-xs font-semibold bg-yellow-400 hover:bg-yellow-300 text-black shadow-[0_8px_25px_rgba(250,204,21,0.6)] shadow-md active:scale-[0.97] transition"
                    >
                      Book Now
                    </button>
                ...
                {isOpen && (
                  <div className="px-3 pb-3 text-[12px] text-gray-700 bg-black/60 border-t border-yellow-400/30">
                    <div className="py-2">
                      {service === "airport" && (
                        <>
                          <div>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      <div className="bg-black/60 border border-yellow-400/30 text-yellow-300">
                      ...
                      <div className="bg-black text-yellow-300 border border-yellow-400/30">
                        <div className="font-semibold text-[12px]">
                          Exclusions
                        </div>
                        <ul className="mt-1.5 text-[11px] space-y-1 list-disc list-inside">
